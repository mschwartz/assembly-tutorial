...
```
    align 8 ; align next data generated at next 8 byte boundary/address
	db 'hello'

	align 16 ; align next data at next 16 byte boundary
	db 'world'

	align 8 ; align next code at next 16 byte boundary
my_code_is_aligned:
```
